...
import {Music, Playlist} from '@/components/netease/netease.type';
...
export function SearchPanel({
  ...
  const [searchResults, setSearchResults] = useState<Music[] | Playlist[]>([]);
    ...
    <div className="flex flex-col h-full min-h-0">
        ...
        <div className="flex flex-col">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              ...
              disabled={loading}
              className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition duration-200 whitespace-nowrap cursor-pointer"
            >
              播放
            </button>
          </div>
        ...
        <div className="flex flex-col">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              ...
              disabled={loading}
              className="px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed transition duration-200 whitespace-nowrap cursor-pointer"
            >
              搜索
            </button>
          </div>
      ...
      <div className="flex flex-col flex-grow min-h-0">
        ...
        <PageSelector itemsPerPage={30} totalCount={totalCount} loading={loading}
                      onFlip={(page: number) => handleSearch(page, searchType, lastSearchedKeyword)}/>
      </div>
    </div>
  );
}
